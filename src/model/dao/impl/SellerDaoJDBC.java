...
public class SellerDaoJDBC implements SellerDao {
    ...
    public Seller findById(Integer id) {
        ...
        try{
            ...
            if (resultSet.next()){
                Department department = instaciateDepartment(resultSet);

                return instaciateSeller(resultSet,department);
            }
            return null;
        }catch (SQLException e){
            throw new DbException(e.getMessage());
    ...
    private Seller instaciateSeller(ResultSet resultSet,Department department) throws SQLException {
    ...
    public List<Seller> findALl() {
        ...
        try {
            ...
            while (resultSet.next()){
                ...
                if (department==null){
                    department = instaciateDepartment(resultSet);
                    map.put(resultSet.getInt("DepartmentId"),department);
                }
                list.add(instaciateSeller(resultSet,department));
            }
            return list;
    ...
    public List<Seller> findByDepartment(Department department) {
        ...
        try{
            ...
            while (resultSet.next()){
                ...
                if (dep == null){
                    dep = instaciateDepartment(resultSet);
                    map.put(resultSet.getInt("DepartmentId"),dep);
                }

                list.add(instaciateSeller(resultSet,dep));
            }
            return list;
        }catch (SQLException e){
            throw new DbException(e.getMessage());
